...
function Form() {
  ...
  useEffect(() => {
    if (state.succeeded) {
      window.location.href = 'https://book.stripe.com/test_9AQeVY0mB2O3gBGfYZ';
    }
  }, [state.succeeded]);
    ...
    <div className='my-16'>
      ...
      <div className="flex justify-center mx-4">
        <form onSubmit={handleSubmit} className="w-full max-w-md font-montserrat">
          ...
          {/* Submit Button */}
          <div className="mb-4">
            <a href='https://book.stripe.com/test_9AQeVY0mB2O3gBGfYZ' target="_blank" rel="noopener noreferrer">
