...
function About() {
  ...
  <h1 className="text-2xl font-bold mb-4 mt-0">Smile Booth 360</h1>
  <div className="flex flex-col md:flex-row items-center justify-center">
    ...
    <div className="w-3/4 md:w-1/2 md:pl-4 mt-4 md:mt-0 text-center md:text-left">
      <p>
      At SmileBooth360, we understand the importance of leaving a lasting impression on your guests. Our cutting-edge technology combines state-of-the-art cameras and advanced software to capture captivating moments from every angle. Whether it's a wedding celebration, a corporate event, a private party, a graduation or any reason to get together, our 360-degree video booths will elevate your overall experience and make your event truly extraordinary.
      </p>
    </div>
  </div>
</div>
