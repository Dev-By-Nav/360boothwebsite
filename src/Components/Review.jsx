  ...
  return (
    <div className="h-full">
      ...
      >
        ...
        <SwiperSlide className=" text-center text-xl bg-[#c94b60] flex justify-center items-center flex-col">
          <h1 className="text-2xl text-white font-montserrat">Private Event</h1>
...
”</p>
        ...
        <SwiperSlide className="text-center text-xl bg-[#c94b60] flex justify-center items-center flex-col">
          <h1 className="text-2xl w-1/3 text-white font-montserrat whitespace-nowrap">Corporate Event</h1>
